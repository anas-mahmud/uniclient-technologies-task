...
function Services() {
  return (
    <div className="lg:w-3/4 sm:w-full max-w-[1400px] p-6 py-12 mx-auto space-y-24">
      ...
      <div className="lg:flex gap-8 items-center">
        <div className="lg:w-1/2 px-8 lg:px-20 space-y-9">
